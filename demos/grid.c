...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        wlx_layout_begin(ctx, 2, WLX_VERT,
            ...
            wlx_textbox(ctx, "Grid Layout Demo",
            ...
            wlx_layout_begin(ctx, 2, WLX_HORZ);
                ...
                wlx_layout_begin(ctx, 2, WLX_VERT,
                    ...
                    wlx_textbox(ctx, "Form (3x2 grid, auto-advance)",
                    ...
                    wlx_grid_begin(ctx, 3, 2,
                        ...
                        wlx_textbox(ctx, "Name:",  .align = WLX_LEFT);
                        wlx_inputbox(ctx, "", name, sizeof(name));
                        wlx_textbox(ctx, "Email:", .align = WLX_LEFT);
                        wlx_inputbox(ctx, "", email, sizeof(email));
                        wlx_textbox(ctx, "Phone:", .align = WLX_LEFT);
                ...
                wlx_layout_begin(ctx, 2, WLX_VERT,
                    ...
                    wlx_textbox(ctx, "Spanning (3x3 grid, grid_cell)",
                        .height = 30, .font_size = 16,
