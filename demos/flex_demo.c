        ...
        wlx_layout_begin(ctx, 2, WLX_VERT,
            ...
            wlx_layout_begin(ctx, 6, WLX_VERT, .padding = 4,
                ...
                wlx_label(ctx, "1) PX(200) + FLEX(1) sidebar + FLEX(3) content",
                    ...
                    .content_align = WLX_LEFT, .show_background = true);
                    ...
                    wlx_layout_begin(ctx, 4, WLX_HORZ,
                        ...
                        wlx_layout_begin_auto(ctx, WLX_VERT, 40);
                            wlx_label(ctx, "[F]",
                                ...
                                .content_align = WLX_CENTER, .font_size = 14, .show_background = true);
                            wlx_label(ctx, "[S]",
                                .back_color = (Color){55, 40, 40, 255},
                                .content_align = WLX_CENTER, .font_size = 14, .show_background = true);
                            wlx_label(ctx, "[T]",
                        ...
                        wlx_label(ctx, "Map",
                            ...
                            .content_align = WLX_CENTER, .font_size = 12, .show_background = true);
