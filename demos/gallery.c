...
static void section_scroll_panel(WLX_Context *ctx, Gallery_State *st) {
    wlx_layout_begin_s(ctx, WLX_VERT,
        WLX_SIZES(
            ...
            WLX_SLOT_CONTENT,  // sub heading
            WLX_SLOT_PX(200),  // auto-height scroll panel (fixed viewport)
            WLX_SLOT_CONTENT,  // sub heading
            WLX_SLOT_PX(180),  // nested panels (fixed viewport height)
            WLX_SLOT_CONTENT,  // options heading
            WLX_SLOT_PX(ROW_H),// scrollbar W slider
            WLX_SLOT_PX(ROW_H),// wheel speed slider
            WLX_SLOT_PX(ROW_H) // show scrollbar checkbox
        ));
...
static void theme_sample_widgets(WLX_Context *ctx) {
    wlx_layout_begin_s(ctx, WLX_VERT,
        WLX_SIZES(
            WLX_SLOT_PX(30),  // label
            WLX_SLOT_PX(34),  // button
            WLX_SLOT_PX(34),  // checkbox
            WLX_SLOT_PX(34),  // slider
            WLX_SLOT_PX(34)   // inputbox
        ), .padding = 2);
    ...
    wlx_split_begin(ctx,
        ...
        wlx_panel_begin(ctx, .title = "Theme Options",
            .title_back_color = heading_color(ctx->theme, 20, 12, 12));
                ...
                wlx_slider(ctx, "BG Red  ", &st->theme_bg_r, .height = 30, .font_size = 13, .thumb_color = RED);
                wlx_slider(ctx, "BG Green", &st->theme_bg_g, .height = 30, .font_size = 13, .thumb_color = GREEN);
                wlx_slider(ctx, "BG Blue ", &st->theme_bg_b, .height = 30, .font_size = 13, .thumb_color = BLUE);

                wlx_label(ctx, "Foreground", .font_size = 14, .height = 24);
                wlx_slider(ctx, "FG Red  ", &st->theme_fg_r, .height = 30, .font_size = 13, .thumb_color = RED);
                wlx_slider(ctx, "FG Green", &st->theme_fg_g, .height = 30, .font_size = 13, .thumb_color = GREEN);
                wlx_slider(ctx, "FG Blue ", &st->theme_fg_b, .height = 30, .font_size = 13, .thumb_color = BLUE);

                wlx_label(ctx, "Surface", .font_size = 14, .height = 24);
                wlx_slider(ctx, "Srf Red ", &st->theme_surface_r, .height = 30, .font_size = 13, .thumb_color = RED);
                wlx_slider(ctx, "Srf Grn ", &st->theme_surface_g, .height = 30, .font_size = 13, .thumb_color = GREEN);
                wlx_slider(ctx, "Srf Blue", &st->theme_surface_b, .height = 30, .font_size = 13, .thumb_color = BLUE);

                wlx_label(ctx, "Accent", .font_size = 14, .height = 24);
                wlx_slider(ctx, "Acc Red ", &st->theme_accent_r, .height = 30, .font_size = 13, .thumb_color = RED);
                wlx_slider(ctx, "Acc Grn ", &st->theme_accent_g, .height = 30, .font_size = 13, .thumb_color = GREEN);
                wlx_slider(ctx, "Acc Blue", &st->theme_accent_b, .height = 30, .font_size = 13, .thumb_color = BLUE);
        ...
        // ======== RIGHT: Content ========
            wlx_layout_begin_s(ctx, WLX_VERT,
                WLX_SIZES(
                    ...
                    WLX_SLOT_PX(220),  // side-by-side panels
...
static void section_borders(WLX_Context *ctx, Gallery_State *st) {
    Color bdr = to_color(st->border_r, st->border_g, st->border_b, 1.0f);
        ...
        wlx_panel_begin(ctx, .title = "Controls",
            .title_back_color = heading_color(ctx->theme, 20, 12, 12));
                ...
                wlx_widget(ctx, .height = 30,
                    .color = bdr, .border_color = (Color){255,255,255,80}, .border_width = 1);
            ...
            .padding = 2);
                ...
                wlx_layout_begin(ctx, 3, WLX_HORZ, .padding = 4);
                    ...
                    wlx_label(ctx, "Red, width 3",
                        .font_size = 16, .height = 40, .show_background = true,
                        .border_color = (Color){255, 60, 60, 255}, .border_width = 3);
                ...
                wlx_layout_begin(ctx, 3, WLX_HORZ, .padding = 4);
                    ...
                    wlx_button(ctx, "Green outline",
                        .font_size = 16, .height = 44, .align = WLX_CENTER,
                        .border_color = (Color){0, 200, 0, 255}, .border_width = 2);
                    wlx_button(ctx, "Yellow thick",
                        .font_size = 16, .height = 44, .align = WLX_CENTER,
                        .border_color = (Color){255, 220, 0, 255}, .border_width = 4);
                wlx_layout_end(ctx);
                ...
                wlx_layout_begin(ctx, 4, WLX_HORZ, .padding = 4);
                    wlx_widget(ctx, .height = 50,
                        .color = (Color){60, 20, 20, 255},
                        .border_color = (Color){255, 100, 100, 255}, .border_width = bw);
                    wlx_widget(ctx, .height = 50,
                        .color = (Color){20, 60, 20, 255},
                        .border_color = (Color){100, 255, 100, 255}, .border_width = bw);
                    wlx_widget(ctx, .height = 50,
                        .color = (Color){20, 20, 60, 255},
                        .border_color = (Color){100, 100, 255, 255}, .border_width = bw);
                    wlx_widget(ctx, .height = 50,
...
int main(void) {
    ...
    Font font_public = LoadFontEx("demos/assets/PublicSans-Regular.ttf", 32, NULL, 0);
    bool font_ok = font_public.glyphCount > 0;
    if (font_ok) SetTextureFilter(font_public.texture, TEXTURE_FILTER_BILINEAR);
    else         printf("WARNING: could not load PublicSans-Regular.ttf\n");
    WLX_Font h_public = font_ok ? wlx_font_from_raylib(&font_public) : WLX_FONT_DEFAULT;

    // -- Mutable theme copies so we can set the font field ------------
    WLX_Theme theme_dark  = wlx_theme_dark;
    WLX_Theme theme_light = wlx_theme_light;
    theme_dark.font  = h_public;
    theme_light.font = h_public;
    ...
    if (font_ok) UnloadFont(font_public);
